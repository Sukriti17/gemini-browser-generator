...
Open the index.html file in a text editor. Find the following line near the top of the main script block:
...
Run Locally:
Simply double-click the index.html file. It will open directly in your web browser (Chrome, Firefox, etc.) and is ready to use.
